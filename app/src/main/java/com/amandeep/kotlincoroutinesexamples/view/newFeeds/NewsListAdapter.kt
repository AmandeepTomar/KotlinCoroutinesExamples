...
import com.amandeep.kotlincoroutinesexamples.view.newFeeds.utils.loadImage
import kotlinx.android.synthetic.main.item_news_artical.view.*
...
class NewsListAdapter: RecyclerView.Adapter<NewsListAdapter.NewsItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int) = NewsItemViewHolder(
        LayoutInflater.from(parent.context).inflate(R.layout.item_news_artical, parent, false)
    )
